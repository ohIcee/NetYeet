...
var registerConfirmPasswordInput = document.getElementsByName(
...
function SendConfirmationMail() {
  let SendConfirmEmailInfo = new SendConfirmationEmailFormInfo(
    LoginInfo["username"]
  );
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data == "SUCCESS") {
        ...
        messageSectionMsg.innerHTML =
          "A confirmation email has been sent. Please confirm your account to login.";
        messageSectionLinks.innerHTML =
...
function SubmitForm(authType) {
  ...
  function ProcessAnonymousLogin() {
    $.ajax({
      type: "POST",
        url: "php/SubmitAuthenticate.php",
        data: {
            authInfo: "anonymous_login",
        },
        success: function (data) {
  ...
  function ProcessRegister() {
    ...
    let RegisterInfo = new RegisterFormInfo(
      Username,
      Email,
      Password,
      ConfirmPassword,
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data == "ERR_DuplicateUsername") {
          ...
          messageSectionLinks.innerHTML =
            "<li><a onclick='SwitchSection(\"register\")'>Register</a><li>";
        }
...
function ProcessForgotPasswordRequest(action) {
  ...
  function SwitchTo() {
    var msg =
      "Please enter the email of the account you want to reset password for";
    var links =
      "" +
  ...
  function Process() {
    var forgotPasswordEmailInput = document.getElementsByName(
      "forgotpasswordrequest-email"
    )[0];

    let forgotPasswordRequestInfo = new ForgotPasswordRequestInfo(
      forgotPasswordEmailInput.value
    );
    let JSONForgotPasswordRequestInfo = JSON.stringify(
      forgotPasswordRequestInfo
    );
...
function ProcessAfterEmailConfirm(success) {
  ...
  if (success) {
    ...
    links = "" + "<li><a onclick='SwitchSection(\"login\")'>Login</a><li>";
  } else {
