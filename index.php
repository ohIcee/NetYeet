...
if (!isset($_SESSION["loggedUserID"]) && !isset($_SESSION["isLoggedInAnonymous"])) {
...
if (isset($_POST['SubmitCreatePostButton'])) {
    ...
    try {
        ...
        if (($PostType != 1 && $PostContent !== "") || $PostType == 1) {
            // INSERT INTO POSTS
            $sql = "INSERT INTO posts (Content, Type, ImageName, Privacy)
            VALUES (:content, :type, :imageName, :privacy)";
            $stmt = $db->prepare($sql);
            ...
            $sql = "INSERT INTO user_posts (UserID, PostID)
            VALUES (:userID, :postID)";
            $stmt = $db->prepare($sql);
            $stmt->bindValue(':userID', $_SESSION["loggedUserID"]);
            $stmt->bindValue(':postID', $db->lastInsertId());
            $result = $stmt->execute();
                ...
                <div class="ui dropdown icon item">
                    ...
                    <div class="menu">
                        <div style="cursor: pointer"
                             onclick="window.location.href='ViewProfile.php?id=<?php echo $_SESSION['loggedUserID']; ?>'"
                             class="item">View Profile
                        </div>
                        <div style="cursor: pointer" onclick="window.location.href='EditProfile.php'" class="item">
                            Profile Settings
                        </div>
...
<div class="ui container">
    ...
    <div class="ui stackable grid">
        ...
        <div class="twelve wide column">
            ...
            <form class="raised segment ui form" action="index.php" method="post" enctype="multipart/form-data"
                  id="CreatePostForm">
                <!-- < Post Input/Preview > -->
                ...
                <div class="ui stackable grid">
                    ...
                    <div class="five wide column">
                        <img id="CreatePostImagePreview" class="ui centered image"
                ...
                <div class="ui stackable three column grid">
                    ...
                    <div class="column">
                        <label for="CreatePostImageInput" class="ui secondary fluid icon button">
                            ...
                            Add Image</label>
                        <input type="file" accept="image/*" id="CreatePostImageInput" style="display:none"
                    ...
                    <div class="column">
                        <button type="submit" name="SubmitCreatePostButton"
                                class="ui submit fluid primary button <?= isset($_SESSION["isLoggedInAnonymous"]) ? "disabled" : "" ?>">
                            Post
                        </button>
                    </div>
            ...
            <div class="ui large feed">
              ...
              <h2 class="ui header">
                ...
                <div class="content">
                  It\'s lonely here!
                  <div class="sub header">Go follow some people! </div>
                </div>
              </h2>
              </div>
                ';
