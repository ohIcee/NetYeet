    ...
    <div id="site-wrapper" class="uk-flex uk-flex-column uk-flex-middle uk-flex-center uk-text-center uk-container">
        ...
        <div class="uk-card uk-card-default uk-card-large uk-card-body uk-width-1-2@m uk-width-1-2@s">
            ...
            <div id="login-section">
                ...
                <button name='login-submit' onclick="SubmitForm('login')" class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom">Prijava
                </button>
                <!--</form>-->

                <p onclick="SubmitForm('anonymous_login')">Anonimna prijava</p>
            ...
            <div id="register-section">
                ...
                <button name="register-submit" onclick="SubmitForm('register')" class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom">Registriraj
                </button>
                <!--</form>-->
