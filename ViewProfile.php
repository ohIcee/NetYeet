...
if (!isset($_GET['id']) || $_GET["id"] === "" && isset($_SESSION["isLoggedInAnonymous"])) {
  header("Location: index.php");
}
...
<script type="text/javascript">
  var loggedUserID = <?php echo isset($_SESSION['loggedUserID']) ? $_SESSION['loggedUserID'] : "-1"; ?>;
  ...
  <div class="ui container">
      ...
      <div class="twelve wide column">
        ...
        <div class="ui middle aligned list">
          ...
          if ($UserPreferences['ShowGender'] == '1') {
            $Gender = $ProfileInfo["Gender"] == 'woman' ? 'female' : 'male';
            echo '
              <div class="item">
    ...
    <div class="ui large feed">
      ...
      foreach ($Posts as $key => $value) :
        ...
        $PostPublishDate = new DateTime($value['PublishDate']);
    ...
    <div class="scrolling content">
      <div id="CommentsModalSegment" class="ui basic segment">
        ...
        <form class="ui reply form">
          ...
          <div onclick="<?= isset($_SESSION["isLoggedInAnonymous"]) ? "" : "PostComment()" ?>" class="ui blue labeled submit icon button <?= isset($_SESSION["isLoggedInAnonymous"]) ? "disabled" : "" ?>">
